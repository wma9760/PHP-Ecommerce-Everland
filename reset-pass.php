...
<?php
    ...
    $emaildata1 = "SELECT * FROM users WHERE token='$tokenIds'";
    
    $emailQuery1 = mysqli_query($con, $emaildata1);
    $emailCount1 = mysqli_num_rows($emailQuery1);
                                    ...
                                    $results = mysqli_query($con, $update_user);
                                        if ($results) {
                                            ...
                                            if ($updateQuery) {
                                                ?>
                                                <script>
                                                    alert("Now you can Login with new Reset password");
                                            ...
                                            ?>
                                                    <script>
                                                        alert("Error! Token Session Expire ")
                                                    </script>
                                          <?php
                                        }
